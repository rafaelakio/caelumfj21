...
@WebServlet(name = "AdicionaContatoServiceServlet", urlPatterns = { "/adicionaContatoService" })
public class AdicionaContatoServiceServlet extends HttpServlet {
	@Override
	protected void service(	HttpServletRequest request,
		...
		try {
			...
			out.println("Contato " + contato.getNome() +
					" adicionado com sucesso via Service");
